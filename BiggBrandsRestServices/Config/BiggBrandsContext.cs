...
namespace BiggBrandsRestServices.Config
{
    public partial class BiggBrandsContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.Product_BKP'. Please see the warning messages.
        // Unable to generate entity type for table 'dbo.localestringresource_ydk'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("server=10.0.0.180;database=BIGGBRANDS_NOPDB;user=sa;password=2005;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.AbroadDesi).HasColumnType("decimal(18, 4)");
                ...
                entity.Property(e => e.BulletPoint1).HasMaxLength(50);

                entity.Property(e => e.BulletPoint2).HasMaxLength(50);

                entity.Property(e => e.BulletPoint3).HasMaxLength(50);

                entity.Property(e => e.BulletPoint4).HasMaxLength(50);

                entity.Property(e => e.BulletPoint5).HasMaxLength(50);
                ...
                entity.Property(e => e.ParcelDesi).HasColumnType("decimal(18, 4)");

                entity.Property(e => e.ParcelWeight).HasColumnType("decimal(18, 4)");
